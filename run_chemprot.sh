...
bio_albert_1_1_large_pubmed_pmc_out_dir=gs://cs93-capstone-project/bio_albert_finetuning/chemprot/run_20201016/
DATA_DIR=/home/jupyter/datasets/ChemProt
python -m albert.run_classifier \
  --data_dir=$DATA_DIR \
  --output_dir=$bio_albert_1_1_large_pubmed_pmc_out_dir \
